                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <a href="UpdateSliderAction.aspx?sid=<%Response.Write(objReader.GetValue(0)); %>&btnName=Update" class="btn btn-info" >Update</a>&nbsp;
                                    <a href="UpdateSliderAction.aspx?sid=<%Response.Write(objReader.GetValue(0)); %>&btnName=Delete" class="btn btn-danger" >Delete</a></td>
                            </tr>
                            <%
                                }
                                objReader.Close();
