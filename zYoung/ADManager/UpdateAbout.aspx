<%@ Page Title="" Language="C#" MasterPageFile="~/ADManager/AdminMaster.master" AutoEventWireup="true" CodeFile="UpdateAbout.aspx.cs" Inherits="ADManager_UpdateAbout" %>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center"><a href="UpdateAboutAction.aspx" class="btn btn-info" >Update</a>&nbsp;<a href="#" class="btn btn-danger" >Delete</a></td>
                            </tr>
                            <%
                                }
                                objReader.Close();
