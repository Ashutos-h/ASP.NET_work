<%@ Page Title="" Language="C#" MasterPageFile="~/ADManager/AdminMaster.master" AutoEventWireup="true" CodeFile="UpdateSliderAction.aspx.cs" Inherits="ADManager_UpdateSliderAction" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <asp:Button ID="btnSubmit" Text="Save" class="btn btn-info" runat="server" OnClick="btnSubmit_Click" />
